...
\begin{table}[H]
    ...
    \input{tables/s3-model-parameters.tex}
...
The Python scripts used to process raw data, perform regression analyses, and generate plots for this lab are available at \url{https://github.com/tahmidazam/3g5-lab}.
